...
public class SpellCheckTest {
    private static String dicpath = "/Users/duty/work/lucene/dic.txt";
    ...
    public void createSpellIndex(String spellIndexPath, String idcFilePath)
            throws IOException {
        Directory spellIndexDir = (Directory) FSDirectory.open(FileSystems.getDefault().getPath(IndexUtils.searchSource));
...
//        spellChecker.indexDictionary(new PlainTextDictionary(,);
    ...
    public void search(String word, int numSug) {
        ...
        try {
            ...
            spellchecker.setAccuracy(0.001f);
//            spellchecker.
            //初始化字典目录
